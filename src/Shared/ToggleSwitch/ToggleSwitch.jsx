  ...
  if (!eventRefs.current) {
    eventRefs.current = {
      handleMove: (e) => {
        ...
        const move =
          (e.touches ? e.touches[0].clientX : e.clientX) - positionsRef.current;
      ...
      <div className={styles.toggleButton}>
        <div className={styles.activePathContainer}>
          <div
            ...
            style={{
              scale: `${circlePosition.translate / rangePathWidth || 0} 1`,
            }}
          />
        </div>
        <div
        ...
        >
          <div
            className={`${styles.round}${
              circlePosition.translate > rangePathWidth / 2
                ? ` ${styles.active}`
                : ""
            }`}
