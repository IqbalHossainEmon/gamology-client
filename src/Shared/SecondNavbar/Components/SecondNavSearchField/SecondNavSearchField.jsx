...
export default function SecondNavSearchField({ setNavShow }) {
  ...
  return (
    <button ref={searchRef} type="button" onClick={handleSearchClick} className={styles.searchField} id={show ? styles.show : styles.hide}>
      ...
      <input ref={searchInputRef} onMouseDown={handleSearchClick} placeholder="Search Here" type="text" />
    </button>
  );
}
