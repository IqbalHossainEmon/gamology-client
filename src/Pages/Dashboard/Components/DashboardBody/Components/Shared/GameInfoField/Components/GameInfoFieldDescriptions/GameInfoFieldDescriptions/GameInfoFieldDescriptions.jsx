  ...
  return (
    <section className={styles.addGameDescriptions}>
      <h3 className={styles.header}>
        {hasDefault ? "Edit" : "Add"} Game&#39;s Descriptions
      </h3>
      <div className={styles.sortDescription}>
        <TextField
          ...
          {...(hasDefault && {
            defaultValue: defaultGameDescriptions.shortDesc,
          })}
        />
      </div>
      <div>
          ...
          <ButtonWithRipple
            ...
            onClick={() => {
              ...
              gameDescriptions.current.gameDescriptions.descriptions[
                gameDescriptions.current.gameDescriptions.descriptions.length -
                  1
              ].mainHeader = "";
            }}
          >
