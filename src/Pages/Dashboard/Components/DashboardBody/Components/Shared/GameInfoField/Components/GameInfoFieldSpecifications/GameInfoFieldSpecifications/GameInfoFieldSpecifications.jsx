  ...
  return (
    <div className={styles.addGameSpecifications}>
      ...
      <GameInfoFieldSpecificationContainer
        ...
        {...(hasDefault && {
          defaultGameSpecifications: defaultGameSpecifications.spec,
        })}
      ...
      <div>
        <GameInfoFieldSpecsLangsSupported
          ...
          {...(hasDefault && {
            defaultValue: defaultGameSpecifications.others,
          })}
          hasDefault={hasDefault}
        />
        <div className={styles.textField}>
          <TextField
            errorChange={errorChange}
            errorMessage={
              errorMessages.current.gameSpecificationsError.copyWrite
            }
            field="input"
            htmlFor="copyright"
            ...
            {...(hasDefault && {
              defaultValue: defaultGameSpecifications.copyWrite,
            })}
          />
        </div>
        <div className={styles.textField}>
          <TextField
            ...
            setState={handleValue}
            {...(hasDefault && {
              defaultValue: defaultGameSpecifications.policy,
            })}
          />
        </div>
      </div>
