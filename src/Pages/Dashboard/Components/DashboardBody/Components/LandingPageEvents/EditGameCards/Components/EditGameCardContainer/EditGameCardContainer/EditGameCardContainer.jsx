...
const handleCardDotList = (
  ...
  function Inner(parentRef, cardInfo) {
    ...
    return (
      <GameCardManagementMenu lists={getListHandler()} parentRef={parentRef} />
    );
  };
          ...
          body: (
            <>
              <p>
                ...
                {isDelete ? "delete?" : "clear the cards?"}
              </p>
              {!isDelete && (
                <p>
  ...
  return (
    <section>
      <GameCards
        ...
        items={cards.cards}
        extraCard={(width, margin) =>
          handleExtraCard(width, margin, handleCardSelection)
        }
        scrollToLast
