import styles from './IndividualGameTags.module.css';

export default function IndividualGameTags({ genes, features }) {
  return (
    <div className={styles.individualGameTags}>
      <div className={styles.individualGameTagGroupContainer}>
        ...
        <ul className={styles.individualGameTagGroup}>
          ...
          {genes.length === 0 && <li className={[styles.individualGameTag, styles.empty]}>-</li>}
        </ul>
      </div>
      <div className={styles.individualGameTagGroupContainer}>
        ...
        <ul className={styles.individualGameTagGroup}>
          ...
          {features.length === 0 && <li className={[styles.individualGameTag, styles.empty]}>-</li>}
        </ul>
      </div>
    </div>
  );
