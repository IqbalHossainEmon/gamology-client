        ...
        <div className={styles.individualGameTags}>
            <div className={styles.individualGameTagGroupContainer}>
                ...
                <ul className={styles.individualGameTagGroup}>
                    {genes.map(gene => (
                        <li
                            className={styles.individualGameTag}
                            key={gene}
                        >
                            {gene}
                        </li>
                    ...
                    {genes.length === 0 && <li className={[styles.individualGameTag, styles.empty]}>
                        -
                    </li>}
                </ul>
            </div>
            ...
            <div className={styles.individualGameTagGroupContainer}>
                ...
                <ul className={styles.individualGameTagGroup}>
                    ...
                    {features.length === 0 && <li className={[styles.individualGameTag, styles.empty]}>
                        -
                    </li>}
                </ul>
            </div>
