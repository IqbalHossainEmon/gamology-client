...
function IndiGameAsideBodyBtn() {
    const buyButtonRef = useRef(null),
     ...
     wishlistBtnRef = useRef(null),

     [isBought, setIsBought] = useState(false),

     [addedToCart, setAddedToCart] = useState(false),

     [wishListState, setWishListState] = useState(0),
